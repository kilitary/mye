...
extern "C"
{
    ...
    /* отдельные каллбеки */ long MYEAPI __stdcall mye_TrayAddCallback(LPVOID addr);
...
/* служебные функции */ BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fwdreason, LPVOID lpvReserved);
