...
extern "C" int mye_GetVal(char *name, LPVOID buf, DWORD size)
{

}

extern "C" int mye_SetVal(char *name, LPVOID buf, DWORD size)
{

}

extern "C" long mye_GetValSize(char *name)
{

}

extern "C" int mye_EnumerateVal(char *prefix = NULL)
{
